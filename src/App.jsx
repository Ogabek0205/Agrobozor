...
const DB = {
  ...
  products: [
    ...
    { id: 8,  name: "Limon",            categoryId: 2, price: 15000, unit: "kg", region: "Toshkent",      seller: "Jasur Toshmatov",     sellerId: 2, stock: 200,   desc: "Issiqxona limoni",                          rating: 4.7, reviews: 29,
      image: "data:image/png;base64,", emoji: "🍋", status: "active", createdAt: "2024-06-20" },
    ...
    { id: 11, name: "Ko'katlar",           categoryId: 5, price: 5000,  unit: "kg", region: "Farg'ona",      seller: "Gulnora Rahimova",    sellerId: 2, stock: 80,    desc: "Yangi shivit, aromatli",                    rating: 4.6, reviews: 15,
      image: "data:image/png;base64,", emoji: "🌿", status: "active", createdAt: "2024-06-22" },
...
const css = `
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .nav {
    ...
    background: rgba(13, 51, 32, 0.7); /* Translucent Glass */
  ...
  .cat-card{border-radius:var(--rad);cursor:pointer;border:3px solid transparent;transition:var(--tr);position:relative;overflow:hidden;box-shadow:0 4px 16px rgba(0,0,0,.1);height:180px;}
  .cat-card:hover{transform:translateY(-6px) scale(1.02);box-shadow:0 16px 40px rgba(0,0,0,.2);}
  ...
  return (
    ...
    >
      <div className="prod-img" onClick={onClick}>
        ...
        <ProductImage image={p.image} emoji={p.emoji} alt={p.name} height="180px" />
        <div className="prod-overlay">
          <button className="view-btn">Tezkor ko'rish</button>
        </div>
      </div>
      <div className="prod-body">
        <div className="prod-cat-small">{p.categoryName || "Mahsulot"}</div>
        <div className="prod-title" onClick={onClick}>{p.name}</div>
        <div className="prod-seller-row">
          <span className="seller-name"><User size={12} /> {p.seller}</span>
          <span className="prod-rating"><Star size={12} className="fill-amber-400 text-amber-400" /> {p.rating}</span>
        </div>
              ...
              return (
                <div key={o.id} style={{ background: "#fff", borderRadius: "var(--rad)", padding: 24, boxShadow: "var(--sh)", marginBottom: 16 }}>
                  <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 16 }}>
                    <div><h4 style={{ color: "var(--g1)" }}>{prod?.image} {prod?.name}</h4><div style={{ fontSize: 13, color: "var(--s3)", marginTop: 4 }}>#{o.id} · {o.createdAt} · 📍 {o.address}</div></div>
...
function ProfilePage({ user, db, setDb, openAddProd, showToast, apiOnline, setUser, updateProfile, setSelProd }) {
  ...
  const confirmDelete = () => {
    ...
    setDb(prev => {
      const updated = prev.products.filter(x => x.id !== confirmDel.id);
      saveLocal('agro_products', updated);
...
function AdminPanel({ db, setDb, showToast, apiOnline }) {
  ...
  const delUser = (id) => { setDb(p => ({ ...p, users: p.users.filter(u => u.id !== id) })); showToast("O'chirildi"); };
  const delProd = (id) => { setDb(p => ({ ...p, products: p.products.filter(pr => pr.id !== id) })); showToast("O'chirildi"); };
  const togProd = (id) => setDb(p => ({ ...p, products: p.products.map(pr => pr.id === id ? { ...pr, status: pr.status === "active" ? "inactive" : "active" } : pr) }));
  ...
  return (
    <div className="admin-layout">
      ...
      <div className="amain">
        ...
        {sec === "orders" && (
          <>
            <div className="ahead"><h2>📦 Buyurtmalar</h2><p>Jami {db.orders.length} ta buyurtma</p></div>
            <table className="tbl">
              <thead><tr><th>#</th><th>Mahsulot</th><th>Xaridor</th><th>Miqdor</th><th>Summa</th><th>Manzil</th><th>Sana</th><th>Holat</th></tr></thead>
...
export default function App() {
  ...
  useEffect(() => {
    ...
    const savedUsers = loadLocal('agro_users', null);
    if (!savedUsers) {
      saveLocal('agro_users', DB.users);
    }
    // Mahsulotlarni localStorage dan yuklash
    const savedProducts = loadLocal('agro_products', null);
    if (savedProducts) {
      setDb(prev => ({ ...prev, products: savedProducts }));
    }
    // Buyurtmalarni yukl
    const savedOrders = loadLocal('agro_orders', DB.orders);
    setDb(prev => ({ ...prev, orders: savedOrders }));
    // Sessiyani tiklash
  ...
  const login = async (email, password) => {
    ...
    const users = loadLocal('agro_users', DB.users);
  ...
  const register = async (data) => {
    ...
    const users = loadLocal('agro_users', DB.users);
    if (users.find(u => u.email === data.email)) { showToast("Bu email allaqachon ro'yxatdan o'tgan!", "err"); setLoading(false); return; }
    const newUser = { id: Date.now(), name: data.name, email: data.email, password: data.password, role: data.role || "buyer", region: data.region || "Toshkent", phone: data.phone || "", createdAt: new Date().toISOString().split("T")[0], avatar: data.name[0].toUpperCase(), bio: "" };
    const updatedUsers = [...users, newUser];
    saveLocal('agro_users', updatedUsers);
    setDb(prev => ({ ...prev, users: updatedUsers })); // db.users ham yangilansin
    setUser(newUser);
    saveLocal('agro_session', newUser);
  ...
  // ── MAHSULOT QO'SHISH (local) ─────────────────────────────────────────────
  const addProduct = async (data) => {
    const p = { id: Date.now(), ...data, price: Number(data.price), stock: Number(data.stock), sellerId: user.id, seller: user.name, rating: 0, reviews: 0, status: "active", createdAt: new Date().toISOString().split("T")[0] };
    setDb(prev => {
      const updated = [p, ...prev.products];
      saveLocal('agro_products', updated);
      return { ...prev, products: updated };
    });
    showToast("Mahsulot qo'shildi va saqlandi! ✅");
  };

  // ── BUYURTMA BERISH (local) ───────────────────────────────────────────────
  const placeOrder = async (cartItems, address) => {
    ...
    setDb(prev => {
      const updated = [...newOrders, ...prev.orders];
      saveLocal('agro_orders', updated);
  ...
  // ── SHARTNOMA TUZISH (local) ──────────────────────────────────────────────
  const createContract = async (data) => {
    const c = { id: Date.now(), ...data, buyerId: user?.id, buyerName: user?.name, status: "active", createdAt: new Date().toISOString().split("T")[0] };
    setDb(p => {
      const updated = [c, ...p.contracts];
      saveLocal('agro_contracts', updated);
      return { ...p, contracts: updated };
    });
    showToast("Shartnoma yaratildi va saqlandi! ✅");
  };

  // ── SHARH QO'SHISH (local) ───────────────────────────────────────────────
  const addReview = async (productId, rating, comment) => {
    const review = { id: Date.now(), productId, userId: user?.id, userName: user?.name || "Foydalanuvchi", rating, comment, date: new Date().toLocaleDateString("uz-UZ"), likes: 0 };
    setDb(prev => {
      const updated = [review, ...prev.reviews];
      // Update product rating
      const prods = prev.products.map(p => {
        if (p.id === productId) {
          const prodRevs = updated.filter(r => r.productId === productId);
          const avg = prodRevs.reduce((s, r) => s + r.rating, 0) / prodRevs.length;
          return { ...p, rating: Math.round(avg * 10) / 10, reviews: prodRevs.length };
        }
        return p;
      });
      saveLocal('agro_products', prods);
      return { ...prev, reviews: updated, products: prods };
    });
    showToast("Sharhingiz qo'shildi! ⭐");
  };

  // ── PROFIL YANGILASH (local) ──────────────────────────────────────────────
  const updateProfile = (updatedUser) => {
    setUser(updatedUser);
    saveLocal('agro_session', updatedUser);
    const users = loadLocal('agro_users', DB.users);
    saveLocal('agro_users', users.map(u => u.id === updatedUser.id ? updatedUser : u));
